"""Logging utilities for the IoT Stream Engine."""
...
def setup_logging():
    ...
    # Create logger
    logger = logging.getLogger("iot_stream_engine")
...
def log_telemetry_data(device_id: str, reading_value: float, provider: str):
    """Log telemetry updates."""
    logger.info(
        "Telemetry Update",
        extra={"device_id": device_id, "reading_value": reading_value, "provider": provider},
    )
