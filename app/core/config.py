"""Configuration settings for the IoT Stream Engine."""
...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = Field(
        default="postgresql://postgres:postgres@localhost:5432/iot_db",
        env="DATABASE_URL",
    ...
    KAFKA_CONSUMER_GROUP: str = Field(
        default="iot_ingestion_group",
        env="KAFKA_CONSUMER_GROUP",
        description="Kafka consumer group ID"
    )
    KAFKA_TOPIC: str = Field(
        default="iot_stream_v1",
        env="KAFKA_TOPIC",
    ...
    ROLLING_AVERAGE_WINDOW: int = Field(
        default=5,
        env="ROLLING_AVERAGE_WINDOW",
        description="Default rolling average window size"
    )
